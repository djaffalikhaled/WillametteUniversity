...
g++  Camera.o Cylinder.o GeometricObject.o Material.o Plane.o PointLight.o Ray.o RenderEngine.o RGBColor.o ShadeRec.o Sphere.o Vector3D.o World.o main.o -lGL -lGLU -lglut -o main
